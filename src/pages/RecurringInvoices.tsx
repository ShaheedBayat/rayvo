...
export default function RecurringInvoices() {
  ...
  // ============================================================
  // FORM STATE — exact copy from CreateInvoice + recurring fields
  // ============================================================
  ...
  // Credit limit tracking (identical to CreateInvoice)
  ...
  // ============================================================
  // CREATION FORM — identical layout to CreateInvoice
  // ============================================================
  if (showForm) {
    return (
      <AppLayout>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="grid gap-6 lg:grid-cols-[1fr_320px]">
            <div className="space-y-6">
              {/* Invoice Details — identical to CreateInvoice */}
              ...
              {/* Recurring Settings — the ONLY addition */}
              <div className="rounded-lg border bg-card p-6 invoice-shadow">
              ...
              {/* Line Items — identical component */}
            ...
            {/* Sidebar — identical to CreateInvoice */}
            <div className="space-y-6">
              <div className="rounded-lg border bg-card p-6 invoice-shadow">
